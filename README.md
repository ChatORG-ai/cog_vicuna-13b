Run Vicuna 13B (https://huggingface.co/eachadea/vicuna-13b/tree/main) on replicate.com

Clone https://huggingface.co/eachadea/vicuna-13b/tree/main to here, and cog push model.
